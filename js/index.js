// 地図表示時の中心座標
var init_center_coords = [139.388695, 36.140717];

// Bing APIのキー
var bing_api_key = 'Ah_uADKUTE1-8w_63zAYCec1tqWj7M0C6yBknjsOi4SHxk5ElUwzDzZVNnSnSi6u';
...
//	papamamap.generate(mapServerList['mierune-normal']);
	...
	map.on('click', function(evt) {
		...
		if (feature && "Point" == feature.getGeometry().getType()) {
			var type = feature.get('Name') ? feature.get('Name') :  feature.get('Type');
			if(type === undefined) {
				return;
			}
